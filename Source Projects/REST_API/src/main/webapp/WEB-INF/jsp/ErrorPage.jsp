...
<body class="bg-purple">
        ...
        <div class="stars">
            <div class="custom-navbar">
                <div class="brand-logo" style="color:white;font-size: 120%;font-family: 'Merienda One', sans-serif;">
                   Smart Home Automations <!-- <img src="http://salehriaz.com/404Page/img/logo.svg" width="80px"> -->
                </div>
            ...
            <div class="central-body">
                ...
                <a href="<%= request.getContextPath()%>" class="btn-go-home"> <!-- target="_blank" -->GO BACK HOME</a>
            </div>
            <div class="objects">
